...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Project.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Label.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Label.class.getName() + ".tickets", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Ticket.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Ticket.class.getName() + ".labels", jcacheConfiguration);
